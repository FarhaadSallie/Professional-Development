...
def placeNewOrder(): #complete
    ...
    payload = '{"instrument": "BKETH","type":"limit", "side":"'+str(ActionBKETH)+'","quantity":"'+str(Quantity)+'","limit_price":"'+str(BKETH)+'","time_in_force":"gtd","expire_time":"'+str(milliseconds)+'"}'
    headers = {
    ...
    try:
        ...
        printError(e)
        placeNewOrder()
    print("BKETH",str(ActionBKBTC),"order made")
#excel import time
...
def printError(e):
    with open('Error.txt', 'a') as f:
        ...
        f.write('\n BKETH Error at'+' '+str(d1)+' '+str(current_time)+' '+'\nError:'+ str(e) + str(e.args)) 
